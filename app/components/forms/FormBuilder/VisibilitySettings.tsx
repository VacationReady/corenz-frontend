...
=======
  const handleDepartmentChange = (deptName: string, checked: boolean) => {
    ...
    const newDepts = checked
      ...
      ? [...visibleToDepartments, deptName]

      : visibleToDepartments.filter(d => d !== deptName);
...
=======
  const handleJobRoleChange = (roleName: string, checked: boolean) => {

    const newJobRoles = checked

      ? [...visibleToJobRoles, roleName]

      : visibleToJobRoles.filter(r => r !== roleName);
              ...
              {departments.map((dept) => (
                ...
                <div key={dept.id} className="flex items-center gap-2">
                  ...
                  <Checkbox
                    ...
                    checked={visibleToDepartments.includes(dept.name)}

                    onCheckedChange={(checked) => handleDepartmentChange(dept.name, Boolean(checked))}
              ...
              {jobRoles.map((role) => (
                ...
                <div key={role.id} className="flex items-center gap-2">
                  ...
                  <Checkbox
                    ...
                    checked={visibleToJobRoles.includes(role.name)}

                    onCheckedChange={(checked) => handleJobRoleChange(role.name, Boolean(checked))}
    ...
    <Card className="p-4">
      ...
      <div className="space-y-4">
              ...
              {departments.map((dept) => (
                ...
                <div key={dept.id} className="flex items-center gap-2">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleDepartmentChange(dept.id, Boolean(checked))}
              ...
              {jobRoles.map((role) => (
                ...
                <div key={role.id} className="flex items-center gap-2">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleJobRoleChange(role.id, Boolean(checked))}
        ...
        <div className="text-xs text-gray-500 mt-3">
          ...
          <p>• If no specific departments or job roles are selected, the form will be visible to all users with the selected roles.</p>



          <p>• Selecting specific departments or job roles will restrict visibility to only those groups.</p>
