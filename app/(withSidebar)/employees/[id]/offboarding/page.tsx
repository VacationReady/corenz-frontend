        ...
        <Card>
          <CardContent className="text-center p-8">
            ...
            <p className="text-gray-600">
              This employee does not have an offboarding record.
            </p>
          </CardContent>
        </Card>
      </PageShell>
    ...
    >
      <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p>
                    ...
                    {offboarding.employee.jobRole || "N/A"}
                  </p>
                  <p>
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  <p>
                    ...
                    {offboarding.initiatedBy.name}
                  </p>
                  <p>
                    <span className="font-medium">Initiated on:</span>{" "}
                    {formatLondonDate(offboarding.initiatedAt)}
                  </p>
                  {offboarding.completedAt && (
                    <p>
                      <span className="font-medium">Completed on:</span>{" "}
                      {formatLondonDate(offboarding.completedAt)}
                    </p>
                  )}
                  <p>
                    <span className="font-medium">Last updated:</span>{" "}
                    {formatLondonDate(offboarding.updatedAt)}
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {offboarding.assetsToReturn &&
            offboarding.assetsToReturn.length > 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    {offboarding.exitInterview.endTime && (
                      <p>
                        ...
                        {formatLondonTime(offboarding.exitInterview.endTime)}
                      </p>
                    )}
                    <p>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p>
                      <span className="font-medium">Email:</span>{" "}
                      {offboarding.exitInterview.interviewer.email}
                    </p>
                  </div>
            ...
            <div className="border-t pt-4">
              ...
              {offboarding.exitInterview.inviteLastSentAt && (
                <p className="text-sm text-gray-500 mt-1">
                  Last sent:{" "}
                  {formatLondon(offboarding.exitInterview.inviteLastSentAt)}
                </p>
              )}
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <p>
                      ...
                      {offboarding.exitInterview.formTemplate?.name || "N/A"}
                    </p>
                    <p>
                      <span className="font-medium">Timing:</span>{" "}
                      {offboarding.exitInterview.formTiming || "N/A"}
                    </p>
                    <p>
                      <span className="font-medium">Status:</span>{" "}
                      {getCompletionStatusBadge(
                        offboarding.exitInterview.completionStatus,
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {offboarding.formSubmissions.length > 0 ? (
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-600">
                          {offboarding.formSubmissions.length} submission
                          {offboarding.formSubmissions.length !== 1 ? "s" : ""}{" "}
                          completed
                        </p>
                        <Dialog>
                          ...
                          <DialogContent
                            title="Completed Form Submissions"
                            className="max-w-4xl max-h-[80vh] overflow-y-auto"
                          >
                            <div className="space-y-6">
                              {offboarding.formSubmissions.map(
                                (submission, index) => (
                                  <div
                                    key={submission.id}
                                  ...
                                  >
                                    <div className="flex items-center justify-between mb-4">
                                      ...
                                      {submission.submittedAt && (
                                        <p className="text-sm text-gray-600">
                                          Submitted:{" "}
                                          {formatLondon(submission.submittedAt)}
                                        </p>
                                      )}
                                    </div>
                                    <FormSubmissionViewer
                                      schema={
                                        ...
                                        offboarding.exitInterview.formTemplate
                                          ?.schemaJson
                                      }
              ...
              {offboarding.exitInterview.scheduledSendAt && (
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-600">
                    <span className="font-medium">
                      Scheduled to send form on:
                    </span>{" "}
                    {formatLondon(offboarding.exitInterview.scheduledSendAt)}
                  </p>
                </div>
              )}
              ...
              {offboarding.exitInterview.sendForm &&
                ["ON_DATE", "NOW"].includes(
                  offboarding.exitInterview.formTiming || "",
                ) &&
