...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8198)), "C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\(withSidebar)\\employees\\page.tsx"],
    ...
    const pages = ["C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\(withSidebar)\\employees\\page.tsx"];
    ...
    const originalPathname = "/(withSidebar)/employees/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6607))
...
function EmployeesPage() {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        fetch("/api/employees").then((res)=>res.json()).then((data)=>setEmployees(data)).catch(()=>setError("Failed to load employees"));
    }, []);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\macke\Downloads\CoreNZ\clean-corenz-frontend\app\(withSidebar)\employees\page.tsx`)
