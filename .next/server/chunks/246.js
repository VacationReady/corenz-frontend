        ...
        return __async(this, arguments, function*(payload, options = {}) {
            ...
            for (const email of payload){
                if (email.react) {
                    if (!this.renderAsync) {
                        try {
                            const { renderAsync  } = yield Promise.all(/* import() */[__webpack_require__.e(212), __webpack_require__.e(211)]).then(__webpack_require__.bind(__webpack_require__, 43211));
