...
function TeamInsights() {
  // Use employees API scoped to my team via managerId to compute insights
  ...
  const insights = useMemo(() => {
    ...
    // Placeholder turnover metric: could be improved with real leavers endpoint
    const turnover12mo = 0;

    // Upcoming anniversaries: createdAt month/day within next 30 days
    ...
    <PageShell title="Manager Dashboard" breadcrumbs={{ items: [{ label: "Dashboard", href: "/dashboard" }, { label: "Manager" }] }}
      action={
        <div className="flex items-center gap-2">
          ...
          <Link href="/employees/new"><Button size="sm"><UserPlus className="w-4 h-4 mr-2" />Add Employee</Button></Link>
