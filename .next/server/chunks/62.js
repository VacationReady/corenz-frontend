...
function SidebarLink({ href , label , icon: Icon , isCollapsed  }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)((link_default()), {
        href: href,
        className: `flex items-center px-3 py-2 rounded transition-all ${isActive ? "bg-neutral-800 text-white font-semibold" : "text-neutral-300 hover:bg-neutral-800"}`,
        children: [
...
function Sidebar() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("aside", {
        className: `transition-all duration-200 bg-neutral-900 text-white p-4 flex flex-col justify-between ${collapsed ? "w-20" : "w-64"}`,
        children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            ...
                            dropdownOpen && !collapsed && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "absolute right-0 mt-2 w-full bg-neutral-800 border border-neutral-700 rounded shadow z-10",
                                children: [
