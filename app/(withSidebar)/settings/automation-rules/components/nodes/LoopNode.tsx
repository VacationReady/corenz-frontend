    ...
    >
      <div className="px-2.5 py-2 space-y-1">
        <div className="flex items-center gap-1.5">
          <div className="flex-shrink-0 w-5 h-5 rounded border border-sky-400 bg-sky-50 flex items-center justify-center text-sky-600">
            {data?.icon || <Repeat className="w-3 h-3" />}
          </div>
