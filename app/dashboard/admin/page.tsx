...
export default function AdminDashboardPage() {
  return (
    <div className="flex flex-col min-h-screen bg-neutral-900 text-white">
      ...
      {/* Full-Height 2x2 Dashboard Grid */}
      <main className="flex-1 p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full min-h-[calc(100vh-3.5rem)]">

          <DashboardWidget title="Outstanding Requests" icon={ClipboardList}>
            <p className="text-2xl font-semibold text-white">7</p>
            <p className="text-sm text-gray-300">Awaiting approval</p>
          </DashboardWidget>
