...
=======
  const { name, slug, description, schema, isActive, visibleToRoles, visibleToDepartments, visibleToJobRoles } = await req.json();
...
=======
  ...
  const updateData: any = { name, slug, description, schema, isActive };
