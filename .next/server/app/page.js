...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        try {
            ...
            dist/* toast.error */.Am.error("Login failed");
        }
    };
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-purple-200",
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "bg-white p-6 rounded shadow-md w-full max-w-sm",
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                    className: "text-xl font-bold mb-4 text-center text-purple-700",
...
var __webpack_exports__ = __webpack_require__.X(0, [315], () => (__webpack_exec__(2110)));
