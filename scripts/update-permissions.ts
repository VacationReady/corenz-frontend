...
async function updatePermissions() {
  console.log(
    "🔄 Updating permission profiles with employee detail screens...\n",
  );
  ...
  try {
    ...
    if (managerProfile) {
      ...
      console.log(
        "✅ Updated Manager permissions with employee detail screens",
      );
    }
    ...
    if (employeeProfile) {
      ...
      console.log(
        "✅ Updated Employee permissions with employee detail screens",
      );
    }
    ...
    for (const user of users) {
      ...
      if (targetProfile) {
        ...
        console.log(
          `✅ Updated ${user.email} to use ${targetProfile.name} profile`,
        );
      }
    }
