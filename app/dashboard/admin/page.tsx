...
export default function AdminDashboardPage() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 w-full"
       style={{ minHeight: "calc(100vh - 3.5rem - 3rem)" }}> {/* header (3.5rem) + padding */}

    <DashboardWidget title="Outstanding Requests" icon={ClipboardList} className="h-full">
    ...
    <DashboardWidget title="Holiday Balance" icon={CalendarCheck2} className="h-full">
    ...
    <DashboardWidget title="Documents Expiring Soon" icon={FileWarning} className="h-full">
    ...
    <DashboardWidget title="HR Insights" icon={BarChartBig} className="h-full">
      <ul className="space-y-1 text-sm text-neutral-400">
