...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6594)), "C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\page.tsx"],
    ...
    const pages = ["C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9530))
...
function LoginPage() {
    const [email, setEmail] = (0,react_experimental_.useState)("");
    const [password, setPassword] = (0,react_experimental_.useState)("");
    ...
    const handleLogin = async ()=>{
        try {
            ...
            dist/* toast.success */.Am.success("Logged in successfully");
            router.push("/dashboard"); // Make sure this route exists under /app/dashboard/page.tsx
        } catch (err) {
            dist/* toast.error */.Am.error("Invalid credentials");
        }
    };
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex items-center justify-center h-screen bg-gradient-to-br from-purple-100 to-white",
        children: [
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\macke\Downloads\CoreNZ\clean-corenz-frontend\app\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [636,382,142,452], () => (__webpack_exec__(8557)));
