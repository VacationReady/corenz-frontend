...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 66830)), "C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\dashboard\\page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 32786)), "C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\layout.tsx"],
          
        }
      ]
      }.children;
    const pages = ["C:\\Users\\macke\\Downloads\\CoreNZ\\clean-corenz-frontend\\app\\dashboard\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 28567))
...
;// CONCATENATED MODULE: ./app/dashboard/LeaveHistory.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 

function LeaveHistory() {
    const [requests, setRequests] = (0,react_.useState)([]);
    const [loading, setLoading] = (0,react_.useState)(true);
    (0,react_.useEffect)(()=>{
        fetch("/api/leave-request").then((res)=>res.json()).then((data)=>setRequests(data)).finally(()=>setLoading(false));
    }, []);
    ...
    if (requests.length === 0) {
        return /*#__PURE__*/ jsx_runtime_.jsx("p", {
            className: "text-sm text-gray-500",
            children: "You haven’t submitted any leave requests yet."
        });
    }
    return /*#__PURE__*/ jsx_runtime_.jsx("ul", {
        className: "text-sm text-gray-700 space-y-1",
        children: requests.map((req)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("li", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("span", {
                        className: `ml-2 px-2 py-1 text-xs rounded ${req.status === "APPROVED" ? "bg-green-100 text-green-800" : req.status === "DECLINED" ? "bg-red-100 text-red-800" : "bg-yellow-100 text-yellow-800"}`,
                        children: req.status
                    })
                ]
            }, req.id))
...
;// CONCATENATED MODULE: ./app/dashboard/ClientDashboard.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 


function ClientDashboard() {
    const [showForm, setShowForm] = (0,react_.useState)(false);
...
function DashboardPage() {
    return /*#__PURE__*/ jsx_runtime_.jsx(ClientDashboard, {});
}
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\macke\Downloads\CoreNZ\clean-corenz-frontend\app\dashboard\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [636,212,318,663], () => (__webpack_exec__(16273)));
