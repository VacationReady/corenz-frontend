...
=======
  // Start with a simple query to get all active forms for debugging
...
=======
  // Filter forms manually for now to debug

  const forms = allForms.filter(form => {

    // Check if user's role is in the form's visible roles
