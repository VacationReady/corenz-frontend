...
async function DELETE(_, { params  }) {
    try {
        ...
        await prisma/* prisma.activationToken.deleteMany */._.activationToken.deleteMany({
            where: {
                employeeId: params.id
            }
        });
        // Then delete the employee
        await prisma/* prisma.employee.delete */._.employee["delete"]({
            where: {
                id: params.id
            }
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [636,904,474], () => (__webpack_exec__(7193)));
