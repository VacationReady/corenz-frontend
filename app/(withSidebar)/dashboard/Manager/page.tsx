...
import { CalendarCheck2, Users, Clock, BarChart3, Search } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6">
          <DashboardWidget title="Holiday Balance" icon={CalendarCheck2}>
            <ul className="space-y-1 text-sm text-gray-300">
              <li>
                Total Entitlement: <strong>240 days</strong>
              </li>
              <li>
                Used: <strong>130 days</strong>
              </li>
              <li>
                Remaining: <strong>110 days</strong>
              </li>
            </ul>
            <div className="mt-4">
          ...
          <DashboardWidget title="Time Off Trends" icon={Clock}>
            <ul className="space-y-1 text-sm text-gray-300">
              <li>
                Avg Sick Days/Employee: <strong>3.2</strong>
              </li>
              <li>
                Most Common Day Off: <strong>Friday</strong>
              </li>
              <li>
                Peak Absence Month: <strong>August</strong>
              </li>
            </ul>
          </DashboardWidget>
          ...
          <DashboardWidget title="Team Insights" icon={BarChart3}>
            <ul className="space-y-1 text-sm text-gray-300">
              <li>
                Turnover (12 mo): <strong>8%</strong>
              </li>
              <li>
                Avg Tenure: <strong>2.9 years</strong>
              </li>
              <li>
                Single Day Absences: <strong>34%</strong>
              </li>
            </ul>
          </DashboardWidget>
        </div>
